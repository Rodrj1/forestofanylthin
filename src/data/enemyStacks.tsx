...
export const forgottenCrypt = [
  ...
  },
  {
    ...skeleton,
    stack: 1,
    id: "Crypt Skeleton2323",
    belongsTo: "enemy",
    updatedHealth: skeleton.health * 1,
    updatedDamage: skeleton.damage * 1,
    maxStack: 1,
    maxHealth: skeleton.health * 1,
  },
  {
    ...skeleton,
    stack: 11,
    id: "Crypt Skeleton123",
    belongsTo: "enemy",
    updatedHealth: skeleton.health * 11,
    updatedDamage: skeleton.damage * 11,
    maxStack: 11,
    maxHealth: skeleton.health * 11,
  },
];
